# [DEPRECATED] Pardot Source dbt Package

> _This package has been archived and is no longer maintained. Use [`dbt_pardot`](https://github.com/fivetran/dbt_pardot) instead, which now contains all models previously found here._
